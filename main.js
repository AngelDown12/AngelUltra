...
import Pino from 'pino'
import { INCJadiBot } from './plugins/jadibot-serbot.js'
...
INCJadiBot({pathINCJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
